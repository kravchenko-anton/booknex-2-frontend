...
import EnterField from '@/screens/auth/register/components/enter-field/enter-field'
import SelectGenres from '@/screens/auth/register/components/select-genres/select-genres'
